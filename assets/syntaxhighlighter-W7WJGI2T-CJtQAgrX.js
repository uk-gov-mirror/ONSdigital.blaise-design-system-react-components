...
import { E as __commonJS, O as __toESM$1, R as require_react, d as require_memoizerific, k as init_chunk_A242L54C, u as init_chunk_ZCFV7BZB } from "./iframe-TnrM84rJ.js";
import { C as _extends, a as init_theming, l as styled, w as init_chunk_LE2LTDW3 } from "./theming-Cwn73GRE.js";
import { a as ScrollArea2, i as ActionBar, n as $319e236875307eab$export$d10ae4f68404609a, o as init_chunk_JT6NUAUC, r as init_chunk_LITCR56V, t as $319e236875307eab$export$a9b970dcc4ae71a9 } from "./chunk-LITCR56V-BxkLXCTG.js";
import { n as init_chunk_242VQQM5, t as _objectWithoutPropertiesLoose } from "./chunk-242VQQM5-CbPhR3aB.js";
//#region node_modules/storybook/dist/_browser-chunks/chunk-UAYGIC3L.js
function _typeof(o) {
...
var init_chunk_UAYGIC3L = __esmMin((() => {
	init_chunk_242VQQM5();
}));
//#endregion
//#region node_modules/storybook/dist/_browser-chunks/syntaxhighlighter-W7WJGI2T.js
...
function createStyleObject(classNames) {
	var elementStyle = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, stylesheet = arguments.length > 2 ? arguments[2] : void 0;
...
function createElement(_ref) {
	...
	if (TagName) {
		...
		return import_react$1.createElement(TagName, _extends({ key }, props), children);
	}
}
...
function getAllLineNumbers(_ref) {
	...
	return lines.map(function(_, i) {
		...
		return import_react$2.createElement("span", {
			key: "line-".concat(i),
...
function AllLineNumbers(_ref2) {
	...
	return import_react$2.createElement("code", { style: Object.assign({}, codeStyle, containerStyle) }, getAllLineNumbers({
...
function assembleLineNumberStyles(lineNumberStyle, lineNumber, largestLineNumber) {
	var defaultLineNumberStyle = {
		...
		textAlign: "right",
		userSelect: "none"
	}, customLineNumberStyle = typeof lineNumberStyle == "function" ? lineNumberStyle(lineNumber) : lineNumberStyle;
	return _objectSpread2(_objectSpread2({}, defaultLineNumberStyle), customLineNumberStyle);
}
function createLineElement(_ref3) {
	var children = _ref3.children, lineNumber = _ref3.lineNumber, lineNumberStyle = _ref3.lineNumberStyle, largestLineNumber = _ref3.largestLineNumber, showInlineLineNumbers = _ref3.showInlineLineNumbers, _ref3$lineProps = _ref3.lineProps, lineProps = _ref3$lineProps === void 0 ? {} : _ref3$lineProps, _ref3$className = _ref3.className, className = _ref3$className === void 0 ? [] : _ref3$className, showLineNumbers = _ref3.showLineNumbers, wrapLongLines = _ref3.wrapLongLines, _ref3$wrapLines = _ref3.wrapLines, properties = (_ref3$wrapLines === void 0 ? !1 : _ref3$wrapLines) ? _objectSpread2({}, typeof lineProps == "function" ? lineProps(lineNumber) : lineProps) : {};
	...
	return wrapLongLines & showLineNumbers && (properties.style = _objectSpread2({ display: "flex" }, properties.style)), {
		type: "element",
		tagName: "span",
		properties,
		children
...
function processLines(codeTree, wrapLines, lineProps, showLineNumbers, showInlineLineNumbers, startingLineNumber, largestLineNumber, lineNumberStyle, wrapLongLines) {
	...
	for (var _loop = function() {
		var node = tree[index], value = node.children[0].value;
...
`)
				...
				if (i === 0) {
					...
					if (stringChild) {
						...
						var _line2 = createLine([lastLineInPreviousSpan], lineNumber2, node.properties.className);
						newTree.push(_line2);
					}
				} else {
					var _line3 = createLine([newChild], lineNumber2, node.properties.className);
					newTree.push(_line3);
				}
			}), lastLineBreakIndex = index;
		}
		index++;
	}; index < tree.length;) _loop();
...
function highlight_default(defaultAstGenerator, defaultStyle) {
	return function(_ref7) {
		...
		var allLineNumbers = showLineNumbers ? import_react$2.createElement(AllLineNumbers, {
			containerStyle: lineNumberContainerStyle,
			codeStyle: codeTagProps.style || {},
			numberStyle: lineNumberStyle,
			startingLineNumber,
			codeString: code
		}) : null, defaultPreStyle = style.hljs || style["pre[class*=\"language-\"]"] || { backgroundColor: "#fff" }, generatorClassName = isHighlightJs(astGenerator) ? "hljs" : "prismjs", preProps = useInlineStyles ? Object.assign({}, rest, { style: Object.assign({}, defaultPreStyle, customStyle) }) : Object.assign({}, rest, {
			className: rest.className ? "".concat(generatorClassName, " ").concat(rest.className) : generatorClassName,
			style: Object.assign({}, customStyle)
		});
		if (wrapLongLines ? codeTagProps.style = _objectSpread2({ whiteSpace: "pre-wrap" }, codeTagProps.style) : codeTagProps.style = _objectSpread2({ whiteSpace: "pre" }, codeTagProps.style), !astGenerator) return import_react$2.createElement(PreTag, preProps, allLineNumbers, import_react$2.createElement(CodeTag, codeTagProps, code));
		...
		var largestLineNumber = startingLineNumber + ((_code$match$length = (_code$match = code.match(/\n/g)) === null || _code$match === void 0 ? void 0 : _code$match.length) !== null && _code$match$length !== void 0 ? _code$match$length : 0), rows = processLines(codeTree, wrapLines, lineProps, showLineNumbers, showInlineLineNumbers, startingLineNumber, largestLineNumber, lineNumberStyle, wrapLongLines);
		return import_react$2.createElement(PreTag, preProps, import_react$2.createElement(CodeTag, codeTagProps, !showInlineLineNumbers && allLineNumbers, renderer({
			rows,
			stylesheet: style,
			useInlineStyles
		})));
...
function useCopyButton({ children = "Copy", childrenOnCopy = "Copied!", content, onCopy, ariaLabel = !1, ariaLabelOnCopy = !1, duration = 3e3 }) {
	let [copied, setCopied] = (0, import_react$3.useState)(!1), timerRef = (0, import_react$3.useRef)(null);
	(0, import_react$3.useEffect)(() => () => {
		timerRef.current && clearTimeout(timerRef.current);
	}, []);
	let handleClick = (0, import_react$3.useCallback)((e) => {
		timerRef.current && clearTimeout(timerRef.current);
	...
	return {
		...
		buttonProps: (0, import_react$3.useMemo)(() => ({
			onClick: handleClick,
...
__esmMin((() => {
	...
	require_bash = __commonJS({ "../../node_modules/refractor/lang/bash.js"(exports, module) {
		"use strict";
		...
		function bash2(Prism) {
			(function(Prism2) {
				...
				for (var toBeCopied = [
					...
					"punctuation",
					"number"
				], inside = insideString.variable[1].inside, i = 0; i < toBeCopied.length; i++) inside[toBeCopied[i]] = Prism2.languages.bash[toBeCopied[i]];
				Prism2.languages.shell = Prism2.languages.bash;
			})(Prism);
		}
	} });
	require_css = __commonJS({ "../../node_modules/refractor/lang/css.js"(exports, module) {
		"use strict";
		module.exports = css2;
	...
	require_graphql = __commonJS({ "../../node_modules/refractor/lang/graphql.js"(exports, module) {
		"use strict";
				...
				function findClosingBracket(open, close) {
					for (var stackHeight = 1, i2 = currentIndex; i2 < validTokens.length; i2++) {
						...
						if (token.type === "punctuation" && typeof content == "string") {
							...
							else if (close.test(content) && (stackHeight--, stackHeight === 0)) return i2;
						}
					}
					return -1;
				}
	...
	require_js_extras = __commonJS({ "../../node_modules/refractor/lang/js-extras.js"(exports, module) {
		"use strict";
		...
		function jsExtras2(Prism) {
			(function(Prism2) {
				Prism2.languages.insertBefore("javascript", "function-variable", { "method-variable": {
				...
				} }), Prism2.languages.insertBefore("javascript", "function", { method: {
					pattern: RegExp("(\\.\\s*)" + Prism2.languages.javascript.function.source),
					lookbehind: !0,
					alias: ["function", "property-access"]
				} }), Prism2.languages.insertBefore("javascript", "constant", { "known-class-name": [{
	...
	require_json = __commonJS({ "../../node_modules/refractor/lang/json.js"(exports, module) {
		"use strict";
	...
	require_jsx = __commonJS({ "../../node_modules/refractor/lang/jsx.js"(exports, module) {
		"use strict";
		module.exports = jsx2;
	...
	require_markdown = __commonJS({ "../../node_modules/refractor/lang/markdown.js"(exports, module) {
		"use strict";
			...
			(function(Prism2) {
				...
				function textContent(html) {
					...
					return text = text.replace(/&(\w{1,8}|#x?[\da-f]{1,8});/gi, function(m, code) {
						...
						} else return KNOWN_ENTITY_NAMES[code] || m;
					}), text;
				}
	...
	require_markup = __commonJS({ "../../node_modules/refractor/lang/markup.js"(exports, module) {
		"use strict";
...
value: function(attrName, lang) {
	...
	require_typescript = __commonJS({ "../../node_modules/refractor/lang/typescript.js"(exports, module) {
		"use strict";
	...
	require_tsx = __commonJS({ "../../node_modules/refractor/lang/tsx.js"(exports, module) {
		"use strict";
		...
		function tsx2(Prism) {
			Prism.register(refractorJsx), Prism.register(refractorTypescript), (function(Prism2) {
				...
				tag.pattern = RegExp(/(^|[^\w$]|(?=<\/))/.source + "(?:" + tag.pattern.source + ")", tag.pattern.flags), tag.lookbehind = !0;
			})(Prism);
		}
	} });
	require_yaml = __commonJS({ "../../node_modules/refractor/lang/yaml.js"(exports, module) {
		"use strict";
	...
	require_immutable = __commonJS({ "../../node_modules/xtend/immutable.js"(exports, module) {
	...
	require_schema = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/schema.js"(exports, module) {
		"use strict";
	...
	require_merge = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/merge.js"(exports, module) {
		"use strict";
		var xtend = require_immutable(), Schema = require_schema();
		module.exports = merge;
		function merge(definitions) {
			for (var length = definitions.length, property = [], normal = [], index = -1, info, space; ++index < length;) info = definitions[index], property.push(info.property), normal.push(info.normal), space = info.space;
			return new Schema(xtend.apply(null, property), xtend.apply(null, normal), space);
		}
	} });
	require_normalize = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/normalize.js"(exports, module) {
		"use strict";
	...
	require_info = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/info.js"(exports, module) {
		"use strict";
		module.exports = Info;
	...
	require_types = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/types.js"(exports) {
		"use strict";
		var powers = 0;
	...
	require_defined_info = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/defined-info.js"(exports, module) {
		"use strict";
		...
		function DefinedInfo(property, attribute, mask, space) {
			var index = -1, check;
			for (mark(this, "space", space), Info.call(this, property, attribute); ++index < checksLength;) check = checks[index], mark(this, check, (mask & types[check]) === types[check]);
		}
		function mark(values, key, value) {
			value && (values[key] = value);
		}
	} });
	require_create = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/create.js"(exports, module) {
		"use strict";
		...
		function create(definition) {
			...
			for (prop in props) info = new DefinedInfo(prop, transform(attributes, prop), props[prop], space), mustUseProperty.indexOf(prop) !== -1 && (info.mustUseProperty = !0), property[prop] = info, normal[normalize(prop)] = prop, normal[normalize(info.attribute)] = prop;
			return new Schema(property, normal, space);
		}
	} });
	require_xlink = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/xlink.js"(exports, module) {
		"use strict";
	...
	require_xml = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/xml.js"(exports, module) {
		"use strict";
		module.exports = require_create()({
			space: "xml",
	...
	require_case_sensitive_transform = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/case-sensitive-transform.js"(exports, module) {
		"use strict";
	...
	require_case_insensitive_transform = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/util/case-insensitive-transform.js"(exports, module) {
		"use strict";
	...
	require_xmlns = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/xmlns.js"(exports, module) {
		"use strict";
		module.exports = require_create()({
			space: "xmlns",
			attributes: { xmlnsxlink: "xmlns:xlink" },
			transform: require_case_insensitive_transform(),
			properties: {
				xmlns: null,
				xmlnsXLink: null
			}
	...
	require_aria = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/aria.js"(exports, module) {
		"use strict";
	...
	require_html = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/lib/html.js"(exports, module) {
		"use strict";
	...
	require_html2 = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/html.js"(exports, module) {
		"use strict";
		var merge = require_merge(), xlink = require_xlink();
		module.exports = merge([
			require_xml(),
			xlink,
			require_xmlns(),
	...
	require_find = __commonJS({ "../../node_modules/hastscript/node_modules/property-information/find.js"(exports, module) {
		"use strict";
	...
	require_space_separated_tokens = __commonJS({ "../../node_modules/hastscript/node_modules/space-separated-tokens/index.js"(exports) {
		"use strict";
		exports.parse = parse;
	...
	require_comma_separated_tokens = __commonJS({ "../../node_modules/hastscript/node_modules/comma-separated-tokens/index.js"(exports) {
		"use strict";
		exports.parse = parse;
		exports.stringify = stringify;
		var comma = ",", space = " ", empty = "";
		function parse(value) {
			for (var values = [], input = String(value || empty), index = input.indexOf(comma), lastIndex = 0, end = !1, val; !end;) index === -1 && (index = input.length, end = !0), val = input.slice(lastIndex, index).trim(), (val || !end) && values.push(val), lastIndex = index + 1, index = input.indexOf(comma, lastIndex);
			return values;
		}
	...
	require_factory = __commonJS({ "../../node_modules/hastscript/factory.js"(exports, module) {
		"use strict";
		...
		function factory(schema, defaultTagName, caseSensitive) {
			...
			function h(selector, properties) {
				...
				return addChild(node.children, children), node.tagName === "template" && (node.content = {
					type: "root",
		...
		function addChild(nodes, value) {
			...
			if (typeof value == "object" && "length" in value) {
				for (index = -1, length = value.length; ++index < length;) addChild(nodes, value[index]);
				return;
			}
		...
		function parsePrimitives(info, name, value) {
			...
			for (length = value.length, index = -1, result = []; ++index < length;) result[index] = parsePrimitive(info, name, value[index]);
			return result;
		}
		...
		function createAdjustMap(values) {
			for (var length = values.length, index = -1, result = {}, value; ++index < length;) value = values[index], result[value.toLowerCase()] = value;
			return result;
		}
	} });
	require_html3 = __commonJS({ "../../node_modules/hastscript/html.js"(exports, module) {
		"use strict";
		var schema = require_html2(), html = require_factory()(schema, "div");
		html.displayName = "html";
		module.exports = html;
	} });
	require_hastscript = __commonJS({ "../../node_modules/hastscript/index.js"(exports, module) {
		"use strict";
		module.exports = require_html3();
	} });
	require_character_entities_legacy = __commonJS({ "../../node_modules/refractor/node_modules/character-entities-legacy/index.json"(exports, module) {
		module.exports = {
			AElig: "Æ",
			AMP: "&",
			Aacute: "Á",
	...
	require_character_reference_invalid = __commonJS({ "../../node_modules/refractor/node_modules/character-reference-invalid/index.json"(exports, module) {
		module.exports = {
			"0": "�",
			"128": "€",
			"130": "‚",
	...
	require_is_decimal = __commonJS({ "../../node_modules/refractor/node_modules/is-decimal/index.js"(exports, module) {
		"use strict";
	...
	require_is_hexadecimal = __commonJS({ "../../node_modules/refractor/node_modules/is-hexadecimal/index.js"(exports, module) {
		"use strict";
	...
	require_is_alphabetical = __commonJS({ "../../node_modules/refractor/node_modules/is-alphabetical/index.js"(exports, module) {
		"use strict";
	...
	require_is_alphanumerical = __commonJS({ "../../node_modules/refractor/node_modules/is-alphanumerical/index.js"(exports, module) {
		"use strict";
	...
	require_decode_entity_browser = __commonJS({ "../../node_modules/refractor/node_modules/parse-entities/decode-entity.browser.js"(exports, module) {
		"use strict";
		var el, semicolon = 59;
	...
	require_parse_entities = __commonJS({ "../../node_modules/refractor/node_modules/parse-entities/index.js"(exports, module) {
		"use strict";
		...
		function parse(value, settings) {
			...
			for (typeof additional == "string" && (additional = additional.charCodeAt(0)), prev = now(), warning = handleWarning ? parseError : noop, index--, length++; ++index < length;) if (character === lineFeed && (column = indent[lines] || 1), character = value.charCodeAt(index), character === ampersand) {
				...
				}, value.slice(start - 1, end)), prev = next) : (characters = value.slice(start - 1, end), queue += characters, column += characters.length, index = end - 1);
			...
			function flush() {
				queue && (result.push(queue), handleText && handleText.call(textContext, queue, {
					start: prev,
					end: now()
				}), queue = "");
			}
	...
	require_prism_core = __commonJS({ "../../node_modules/refractor/node_modules/prismjs/components/prism-core.js"(exports, module) {
		var Prism = (function(_self2) {
			var lang = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, uniqueId = 0, plainTextGrammar = {}, _ = {
					...
					clone: function deepClone(o, visited) {
						...
						switch (_.util.type(o)) {
							case "Object":
								...
								for (var key in o) o.hasOwnProperty(key) && (clone[key] = deepClone(o[key], visited));
								return clone;
							case "Array": return id = _.util.objId(o), visited[id] ? visited[id] : (clone = [], visited[id] = clone, o.forEach(function(v, i) {
				...
				*/
				highlightAllUnder: function(container, async, callback) {
					...
					for (var i = 0, element; element = env.elements[i++];) _.highlightElement(element, async === !0, env.callback);
				},
				/**
				...
				*/
				highlight: function(text, grammar, language) {
					...
					if (_.hooks.run("before-tokenize", env), !env.grammar) throw new Error("The language \"" + env.language + "\" has no grammar.");
				...
				hooks: {
					...
					*/
					run: function(name, env) {
						...
						if (!(!callbacks || !callbacks.length)) for (var i = 0, callback; callback = callbacks[i++];) callback(env);
					}
				},
				Token
			};
					...
					for (var j = 0; j < patterns.length; ++j) {
						...
						for (var pattern = patternObj.pattern || patternObj, currentNode = startNode.next, pos = startPos; currentNode !== tokenList.tail && !(rematch && pos >= rematch.reach); pos += currentNode.value.length, currentNode = currentNode.next) {
							...
							if (!(str instanceof Token)) {
								...
								if (greedy) {
									if (match = matchPattern(pattern, pos, text, lookbehind), !match || match.index >= text.length) break;
									var from = match.index, to = match.index + match[0].length, p = pos;
									for (p += currentNode.value.length; from >= p;) currentNode = currentNode.next, p += currentNode.value.length;
								...
								} else if (match = matchPattern(pattern, 0, str, lookbehind), !match) continue;
			...
			function toArray(list) {
				for (var array = [], node = list.head.next; node !== list.tail;) array.push(node.value), node = node.next;
				return array;
			}
			if (!_self2.document) return _self2.addEventListener && (_.disableWorkerMessageHandler || _self2.addEventListener("message", function(evt) {
	...
	require_clike = __commonJS({ "../../node_modules/refractor/lang/clike.js"(exports, module) {
		"use strict";
	...
	require_javascript = __commonJS({ "../../node_modules/refractor/lang/javascript.js"(exports, module) {
		"use strict";
	...
	require_core = __commonJS({ "../../node_modules/refractor/core.js"(exports, module) {
		"use strict";
		...
		function alias(name, alias2) {
			...
			for (key in map) for (list = map[key], list = typeof list == "string" ? [list] : list, length = list.length, index = -1; ++index < length;) languages[list[index]] = languages[key];
		}
		...
		function listLanguages() {
			...
			for (language in languages) own.call(languages, language) && typeof languages[language] == "object" && list.push(language);
			return list;
		}
		function stringify(value, language, parent) {
			...
			return typeof value == "string" ? {
				type: "text",
				value
			} : refract.util.type(value) === "Array" ? stringifyAll(value, language) : (env = {
				type: value.type,
				...
				language,
				parent
			}, value.alias && (env.classes = env.classes.concat(value.alias)), refract.hooks.run("wrap", env), h(env.tag + "." + env.classes.join("."), attributes(env.attributes), env.content));
		}
		function stringifyAll(values, language) {
			for (var result = [], length = values.length, index = -1, value; ++index < length;) value = values[index], value !== "" && value !== null && value !== void 0 && result.push(value);
			for (index = -1, length = result.length; ++index < length;) value = result[index], result[index] = refract.Token.stringify(value, language, result);
			return result;
		}
	...
	import_memoizerific = __toESM$1(require_memoizerific(), 1);
	classNameCombinations = {};
	bash_default = __toESM$1(require_bash()).default;
	css_default = __toESM$1(require_css()).default;
	graphql_default = __toESM$1(require_graphql()).default;
	js_extras_default = __toESM$1(require_js_extras()).default;
	json_default = __toESM$1(require_json()).default;
	jsx_default = __toESM$1(require_jsx()).default;
	markdown_default = __toESM$1(require_markdown()).default;
	markup_default = __toESM$1(require_markup()).default;
	tsx_default = __toESM$1(require_tsx()).default;
	typescript_default = __toESM$1(require_typescript()).default;
	yaml_default = __toESM$1(require_yaml()).default;
	...
	newLineRegex = /\n/g;
	import_core = __toESM$1(require_core()), SyntaxHighlighter = highlight_default(import_core.default, {});
	...
	themedSyntax = (0, import_memoizerific.default)(2)((theme) => Object.entries(theme.code || {}).reduce((acc, [key, val]) => ({
		...acc,
		[`* .${key}`]: val
	...
	} : {}, ({ showLineNumbers }) => showLineNumbers ? { ".react-syntax-highlighter-line-number::before": { content: "attr(data-line-number)" } } : {}), UnstyledScroller = ({ children, className }) => import_react.createElement(ScrollArea2, {
		horizontal: !0,
		vertical: !0,
		focusable: !0,
		className
	}, children), Scroller = styled(UnstyledScroller)({
		flex: 1,
		flexShrink: 0,
		flexBasis: "fit-content",
		maxWidth: "100%"
	}, ({ theme }) => themedSyntax(theme)), Pre = styled.pre(({ theme, padded }) => ({
		display: "flex",
		...
		let children = [...row.children], lineNumberNode = children[0], lineNumber = lineNumberNode.children[0].value;
		return children[0] = {
			...lineNumberNode,
			children: [],
			properties: {
				...
				style: {
					...lineNumberNode.properties.style,
					userSelect: "auto"
				}
			}
		}, {
		...
		useInlineStyles,
		key: `code-segement${i}`
	})), wrapRenderer = (renderer, showLineNumbers) => showLineNumbers ? renderer ? ({ rows, ...rest }) => renderer({
		rows: rows.map((row) => processLineNumber(row)),
		...rest
	}) : defaultRenderer2 : renderer, SyntaxHighlighter2 = ({ children, language = "jsx", copyable = !1, bordered = !1, padded = !1, format = !0, formatter = void 0, className = void 0, showLineNumbers = !1, ...rest }) => {
		if (typeof children != "string" || !children.trim()) return null;
		let [highlightableCode, setHighlightableCode] = (0, import_react.useState)("");
		...
		let { children: copyChildren, buttonProps: copyButtonProps } = useCopyButton({ content: highlightableCode }), renderer = wrapRenderer(rest.renderer, showLineNumbers);
		return import_react.createElement(Wrapper, {
			bordered,
			padded,
			showLineNumbers,
			className
		}, import_react.createElement(Scroller, null, import_react.createElement(prism_light_default, {
			...
			...rest,
			renderer
		}, highlightableCode)), copyable ? import_react.createElement(ActionBar, {
			actionItems: [{
				title: copyChildren,
...
export { SyntaxHighlighter2 as SyntaxHighlighter, syntaxhighlighter_default as default, supportedLanguages };
