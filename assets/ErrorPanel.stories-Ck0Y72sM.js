...
var init_ErrorPanel = __esmMin((() => {
	...
	try {
		...
		ErrorPanel.__docgenInfo = {
			...
			"filePath": "/home/runner/work/ONSdigital.blaise-design-system-react-components/ONSdigital.blaise-design-system-react-components/src/components/ErrorPanel.tsx",
			"methods": [],
			"props": {
				"text": {
					"defaultValue": { "value": "Sorry, there is a problem with this service. We are working to fix the problem. Please try again later." },
					"declarations": [{
						"fileName": "ONSdigital.blaise-design-system-react-components/src/components/ErrorPanel.tsx",
						"name": "Props"
					}],
