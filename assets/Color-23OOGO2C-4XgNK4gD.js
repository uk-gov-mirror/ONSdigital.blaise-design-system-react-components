...
import { R as require_react, n as __toESM$1, r as init_chunk_SL3VIQZ3, t as __commonJS } from "./iframe-TnrM84rJ.js";
import { r as init_chunk_S2IHWCOG, t as getControlId } from "./chunk-S2IHWCOG-QPeABEzo.js";
import { a as init_theming, l as styled } from "./theming-Cwn73GRE.js";
import { N as MarkupIcon, V as init_dist, d as PopoverProvider, n as Button, o as Form, x as init_components } from "./components-C-T5P2_B.js";
//#region node_modules/@storybook/addon-docs/dist/_browser-chunks/Color-23OOGO2C.js
...
function i(e2) {
	var t2 = (0, import_react$1.useRef)(e2), n2 = (0, import_react$1.useRef)(function(e3) {
		t2.current && t2.current(e3);
	});
	return t2.current = e2, n2.current;
}
function Y(e2, t2, l2) {
	var u2 = i(l2), c2 = (0, import_react$1.useState)(function() {
		return e2.toHsva(t2);
	}), s2 = c2[0], f2 = c2[1], v2 = (0, import_react$1.useRef)({
		color: t2,
		hsva: s2
	});
	...
	}, [t2, e2]), (0, import_react$1.useEffect)(function() {
		var r2;
	...
	return [s2, (0, import_react$1.useCallback)(function(e3) {
		f2(function(r2) {
			return Object.assign({}, r2, e3);
		});
	}, [])];
}
var import_react, import_react$1, require_color_name, require_conversions, require_route, import_color_convert, placeholderSymbol, placeholderSymbol2, s, f, v, d, h, m, g, p, b, _, x, C, E, H, N, w, y, q, k, I, z, D, K, L, S, T, F, P, X, R, V, $, J, Q, U, W, Z, ee, re, le, ue, Ee, He, Wrapper, TooltipContent, Swatches, swatchBackground, SwatchColor, Input, PopoverTrigger, CycleColorSpaceButton, ColorSpace, COLOR_SPACES, COLOR_REGEXP, RGB_REGEXP, HSL_REGEXP, HEX_REGEXP, SHORTHEX_REGEXP, ColorPicker, fallbackColor, stringToArgs, parseRgb, parseHsl, parseHexOrKeyword, parseValue, getRealValue, useColorInput, id, usePresets, ColorControl, Color_default;
//#endregion
__esmMin((() => {
	init_chunk_S2IHWCOG();
	init_chunk_SL3VIQZ3();
	...
	init_theming();
	require_color_name = __commonJS({ "../../../node_modules/color-name/index.js"(exports, module) {
		"use strict";
		module.exports = {
			aliceblue: [
				240,
	...
	require_conversions = __commonJS({ "../../../node_modules/color-convert/conversions.js"(exports, module) {
		...
		convert2.rgb.hsl = function(rgb) {
			...
			let l2 = (min + max) / 2;
			return max === min ? s2 = 0 : l2 <= .5 ? s2 = delta / (max + min) : s2 = delta / (2 - max - min), [
				h2,
				s2 * 100,
				l2 * 100
			];
		...
		convert2.rgb.hwb = function(rgb) {
			...
			return b2 = 1 - 1 / 255 * Math.max(r2, Math.max(g2, b2)), [
				h2,
				w2 * 100,
				b2 * 100
			];
		...
		convert2.rgb.xyz = function(rgb) {
			...
			let x2 = r2 * .4124 + g2 * .3576 + b2 * .1805, y2 = r2 * .2126 + g2 * .7152 + b2 * .0722, z2 = r2 * .0193 + g2 * .1192 + b2 * .9505;
			return [
				x2 * 100,
				y2 * 100,
				z2 * 100
		...
		convert2.hsl.hsv = function(hsl) {
			let h2 = hsl[0], s2 = hsl[1] / 100, l2 = hsl[2] / 100, smin = s2, lmin = Math.max(l2, .01);
			l2 *= 2, s2 *= l2 <= 1 ? l2 : 2 - l2, smin *= lmin <= 1 ? lmin : 2 - lmin;
			let v2 = (l2 + s2) / 2;
			return [
				h2,
				(l2 === 0 ? 2 * smin / (lmin + smin) : 2 * s2 / (l2 + s2)) * 100,
				v2 * 100
			];
		};
		...
		convert2.hsv.hsl = function(hsv) {
			let h2 = hsv[0], s2 = hsv[1] / 100, v2 = hsv[2] / 100, vmin = Math.max(v2, .01), sl, l2;
			l2 = (2 - s2) * v2;
			let lmin = (2 - s2) * vmin;
			return sl = s2 * vmin, sl /= lmin <= 1 ? lmin : 2 - lmin, sl = sl || 0, l2 /= 2, [
				h2,
				sl * 100,
				l2 * 100
			];
		...
		convert2.lab.xyz = function(lab) {
			...
			return y2 = y22 > .008856 ? y22 : (y2 - 16 / 116) / 7.787, x2 = x22 > .008856 ? x22 : (x2 - 16 / 116) / 7.787, z2 = z22 > .008856 ? z22 : (z2 - 16 / 116) / 7.787, x2 *= 95.047, y2 *= 100, z2 *= 108.883, [
				x2,
				y2,
				z2
			];
		...
		convert2.lch.lab = function(lch) {
			let l2 = lch[0], c2 = lch[1], hr = lch[2] / 360 * 2 * Math.PI;
			return [
				l2,
				c2 * Math.cos(hr),
				c2 * Math.sin(hr)
		...
		convert2.ansi16.rgb = function(args) {
			let color = args % 10;
			if (color === 0 || color === 7) return args > 50 && (color += 3.5), color = color / 10.5 * 255, [
				color,
				color,
				color
			];
		...
		convert2.rgb.hcg = function(rgb) {
			...
			return chroma < 1 ? grayscale = min / (1 - chroma) : grayscale = 0, chroma <= 0 ? hue = 0 : max === r2 ? hue = (g2 - b2) / chroma % 6 : max === g2 ? hue = 2 + (b2 - r2) / chroma : hue = 4 + (r2 - g2) / chroma, hue /= 6, hue %= 1, [
				hue * 360,
				chroma * 100,
				grayscale * 100
			];
		...
		convert2.hsl.hcg = function(hsl) {
			let s2 = hsl[1] / 100, l2 = hsl[2] / 100, c2 = l2 < .5 ? 2 * s2 * l2 : 2 * s2 * (1 - l2), f2 = 0;
			return c2 < 1 && (f2 = (l2 - .5 * c2) / (1 - c2)), [
				hsl[0],
				c2 * 100,
				f2 * 100
			];
		...
		convert2.hcg.rgb = function(hcg) {
			...
			let pure = [
				...
				0,
				0
			], hi = h2 % 1 * 6, v2 = hi % 1, w2 = 1 - v2, mg = 0;
			switch (Math.floor(hi)) {
				...
				case 4:
					...
					break;
				default: pure[0] = 1, pure[1] = 0, pure[2] = w2;
			}
			return mg = (1 - c2) * g2, [
				(c2 * pure[0] + mg) * 255,
				(c2 * pure[1] + mg) * 255,
		...
		convert2.hcg.hsv = function(hcg) {
			let c2 = hcg[1] / 100, v2 = c2 + hcg[2] / 100 * (1 - c2), f2 = 0;
			return v2 > 0 && (f2 = c2 / v2), [
				hcg[0],
				f2 * 100,
				v2 * 100
			];
		...
		convert2.hcg.hsl = function(hcg) {
			let c2 = hcg[1] / 100, l2 = hcg[2] / 100 * (1 - c2) + .5 * c2, s2 = 0;
			return l2 > 0 && l2 < .5 ? s2 = c2 / (2 * l2) : l2 >= .5 && l2 < 1 && (s2 = c2 / (2 * (1 - l2))), [
				hcg[0],
				s2 * 100,
				l2 * 100
			];
		...
		convert2.hcg.hwb = function(hcg) {
			let c2 = hcg[1] / 100, v2 = c2 + hcg[2] / 100 * (1 - c2);
			return [
				hcg[0],
				(v2 - c2) * 100,
				(1 - v2) * 100
	...
	require_route = __commonJS({ "../../../node_modules/color-convert/route.js"(exports, module) {
	...
	import_color_convert = __toESM$1(__commonJS({ "../../../node_modules/color-convert/index.js"(exports, module) {
	...
	s = function(e2, r2, t2) {
	...
	}, m = import_react$1.memo(function(o2) {
		var a2 = o2.onMove, l2 = o2.onKey, s2 = c(o2, ["onMove", "onKey"]), m2 = (0, import_react$1.useRef)(null), g2 = i(a2), p2 = i(l2), b2 = (0, import_react$1.useRef)(null), _2 = (0, import_react$1.useRef)(!1), x2 = (0, import_react$1.useMemo)(function() {
			var e2 = function(e3) {
		...
		return (0, import_react$1.useEffect)(function() {
			return H2;
		}, [H2]), import_react$1.createElement("div", u({}, s2, {
			onTouchStart: C2,
			onMouseDown: C2,
		...
		var t2 = r2.color, n2 = r2.left, o2 = r2.top, a2 = o2 === void 0 ? .5 : o2, l2 = g(["react-colorful__pointer", r2.className]);
		return import_react$1.createElement("div", {
			className: l2,
			style: {
				top: 100 * a2 + "%",
				left: 100 * n2 + "%"
			}
		}, import_react$1.createElement("div", {
	...
	S = import_react$1.memo(function(r2) {
		var t2 = r2.hue, n2 = r2.onChange, o2 = g(["react-colorful__hue", r2.className]);
		return import_react$1.createElement("div", { className: o2 }, import_react$1.createElement(m, {
			onMove: function(e2) {
				n2({ h: 360 * e2.left });
			},
			onKey: function(e2) {
			...
			"aria-valuemax": "360",
			"aria-valuemin": "0"
		}, import_react$1.createElement(p, {
	...
	}), T = import_react$1.memo(function(r2) {
		var t2 = r2.hsva, n2 = r2.onChange, o2 = { backgroundColor: q({
			h: t2.h,
			s: 100,
			v: 100,
			a: 1
		...
		return import_react$1.createElement("div", {
			...
			style: o2
		}, import_react$1.createElement(m, {
			onMove: function(e2) {
				n2({
					s: 100 * e2.left,
					v: 100 - 100 * e2.top
	...
	V = typeof window < "u" ? import_react$1.useLayoutEffect : import_react$1.useEffect, $ = function() {
	...
	J = /* @__PURE__ */ new Map(), Q = function(e2) {
		...
		var n2 = t2.className, o2 = t2.colorModel, a2 = t2.color, l2 = a2 === void 0 ? o2.defaultColor : a2, i2 = t2.onChange, s2 = c(t2, [
			"className",
			"colorModel",
			"color",
			"onChange"
		]), f2 = (0, import_react$1.useRef)(null);
		Q(f2);
		var v2 = Y(o2, l2, i2), d2 = v2[0], h2 = v2[1], m2 = g(["react-colorful", n2]);
		return import_react$1.createElement("div", u({}, s2, {
			ref: f2,
			className: m2
		}), import_react$1.createElement(T, {
			hsva: d2,
			onChange: h2
		}), import_react$1.createElement(S, {
			hue: d2.h,
			onChange: h2,
		...
		return import_react$1.createElement(U, u({}, r2, { colorModel: W }));
	}, ee = function(r2) {
		...
		return import_react$1.createElement("div", { className: l2 }, import_react$1.createElement("div", {
		...
		return import_react$1.createElement("div", u({}, s2, {
			...
			hue: d2.h,
			onChange: h2
		}), import_react$1.createElement(ee, {
			hsva: d2,
			onChange: h2,
			className: "react-colorful__last-control"
		}));
	...
	le = {
		...
		return import_react$1.createElement(re, u({}, r2, { colorModel: le }));
	};
	Ee = {
		...
		return import_react$1.createElement(re, u({}, r2, { colorModel: Ee }));
	};
	Wrapper = styled.div({
		position: "relative",
		maxWidth: 250
		...
		marginTop: 5,
		width: 200
	}), swatchBackground = (isDark) => `url('data:image/svg+xml;charset=utf-8,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity="0.05" fill="${isDark ? "white" : "black"}"><path d="M8 0h8v8H8zM0 8h8v8H0z"/></svg>')`, SwatchColor = styled(Button)(({ value, selected, theme }) => ({
		width: 16,
		height: 16,
		...
		"[aria-readonly=\"true\"] > &": { background: theme.base === "light" ? theme.color.lighter : "transparent" }
		...
		let [r2, g2, b2, a2] = stringToArgs(value), [h2, s2, l2] = import_color_convert.default.rgb.hsl([
			r2,
			g2,
			b2
		]) || [
		...
		return {
			valid: !0,
			value,
			keyword: import_color_convert.default.rgb.keyword([
				r2,
				g2,
				b2
			]),
			...
			hex: `#${import_color_convert.default.rgb.hex([
				r2,
				g2,
				b2
			]).toLowerCase()}`
		...
		let [h2, s2, l2, a2] = stringToArgs(value), [r2, g2, b2] = import_color_convert.default.hsl.rgb([
			h2,
			s2,
			l2
		]) || [
		...
		return {
			valid: !0,
			value,
			keyword: import_color_convert.default.hsl.keyword([
				h2,
				s2,
				l2
			]),
			...
			hsl: value,
			hex: `#${import_color_convert.default.hsl.hex([
				h2,
				s2,
				l2
			]).toLowerCase()}`
		...
		let [value, setValue] = (0, import_react.useState)(initialValue || ""), [color, setColor] = (0, import_react.useState)(() => parseValue(value)), [colorSpace, setColorSpace] = (0, import_react.useState)(color?.colorSpace || "hex");
		...
		return {
			value,
			realValue: (0, import_react.useMemo)(() => getRealValue(value, color, colorSpace).toLowerCase(), [
				value,
				color,
				colorSpace
			]),
			updateValue: (0, import_react.useCallback)((update) => {
			...
			color,
			colorSpace,
			cycleColorSpace: (0, import_react.useCallback)(() => {
				let nextSpace = COLOR_SPACES[(COLOR_SPACES.indexOf(colorSpace) + 1) % COLOR_SPACES.length];
		...
		let [selectedColors, setSelectedColors] = (0, import_react.useState)(currentColor?.valid ? [currentColor] : []);
		(0, import_react.useEffect)(() => {
			currentColor === void 0 && setSelectedColors([]);
		}, [currentColor]);
		let presets = (0, import_react.useMemo)(() => {
			let combined = (presetColors || []).map((preset) => typeof preset == "string" ? parseValue(preset) : preset.title ? {
				...parseValue(preset.color),
				keyword: preset.title
			} : parseValue(preset.color)).concat(selectedColors).filter(Boolean);
			if (maxPresetColors === 0 || maxPresetColors === Infinity) return combined;
		...
		return {
			presets,
			addPreset: (0, import_react.useCallback)((color) => {
	...
	}, ColorControl = ({ name, storyId, value: initialValue, onChange, onFocus, onBlur, presetColors, maxPresetColors, startOpen = !1, argType }) => {
		let { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(initialValue, (0, import_react.useCallback)(debounce(onChange, 200), [onChange])), { presets, addPreset } = usePresets(presetColors ?? [], color, colorSpace, maxPresetColors), Picker = ColorPicker[colorSpace], readOnly = !!argType?.table?.readonly, controlId = getControlId(name, storyId);
		return import_react.createElement(Wrapper, null, import_react.createElement("label", {
			htmlFor: controlId,
			className: "sb-sr-only"
		}, name), import_react.createElement(Input, {
			id: controlId,
			value,
		...
		}), import_react.createElement(PopoverProvider, {
			ariaLabel: "Color picker",
			defaultVisible: startOpen,
			visible: readOnly ? !1 : void 0,
			onVisibleChange: () => color && addPreset(color),
			popover: import_react.createElement(TooltipContent, null, import_react.createElement(Picker, {
				color: realValue === "transparent" ? "#000000" : realValue,
				onChange: updateValue,
				onFocus,
				onBlur
			}), presets.length > 0 && import_react.createElement(Swatches, null, presets.map((preset, index) => import_react.createElement(SwatchColor, {
		...
		}, import_react.createElement(PopoverTrigger, {
			variant: "ghost",
			padding: "small",
			size: "small",
			...
			style: { margin: 4 },
			disabled: readOnly
		})), value ? import_react.createElement(CycleColorSpaceButton, {
			variant: "ghost",
			padding: "small",
			size: "small",
		...
		}, import_react.createElement(MarkupIcon, null)) : null);
